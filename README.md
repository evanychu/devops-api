...
This project demonstrates the use of SAM Command Line Interface (CLI) to:
...
This project also demonstrates the use of GitHub Actions to deploy the API Gateway and Lambda by executing the SAM CLI.
...
## GitHub Actions
This main branch is integrated with GitHub Actions to manually trigger the deployment of the API Gateway and Lambda by using the SAM CLI.
